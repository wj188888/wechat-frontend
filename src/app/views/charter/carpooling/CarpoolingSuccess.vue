  ...
  <main-box :title="title" main-class="scrollingBox has-abs-bottom">
    ...
    <div class="carpooling-detail-box">
      <ul class="carpooling-user-list" :class="{'one-row': lineSkuData.minTeamMember < 5 }">
        <li :class="{'ten-more': lineSkuData.minTeamMember > 10, 'active': i <= (lineSkuData.minTeamMember - lineSkuData.availableSeats)}" v-for="i in lineSkuData.minTeamMember">
    ...
    <div class="form-box form-detail mar-b-40 mar-t-40">
      ...
      lineSkuFindShareLine (skuId) {
        ...
        api.lineSkuFindShareLine({
          ...
          if (data.resultCode == '0') {
             ...
             * 微信分享
             */
            let shareUrl = TOOL.shareURL + 'carpoolingShare' + '?skuId=' + this.skuId
            interfaceApi.share({
              share: true,
              shareUrl: shareUrl,
