<template>
  <main-box :title="title" main-class="pad-20">
    <product-top-nav ctg="TRAIN_STATION_BUS" :active="0" :nav2router="jumpToTrainSendSearch"></product-top-nav>
    <search-box
            :start-place="searchKeys.startPlace"
            :end-place="searchKeys.endPlace"
            @changeStation="jumpToTrainSendSearch"
            @jumpToFrom="jumpToTrainStation"
  ...
  export default {
    ...
    data () {
      return {
        ...
        searchKeys: {
          startPlace: TOOL.placeHolder.onTrainStation,
    ...
    methods: {
      ...
      jumpToTrainSendSearch () {
        ...
        if (this.searchKeys.startPlace != TOOL.placeHolder.onTrainStation) {
      ...
      jumpToCitySearch (place) {
        ...
        this.$router.push({
          ...
          query: {
            ...
            placeType: place,
            source: this.searchKeys.startPlace,
