      ...
      <div class="price-detail" v-show="priceMore && showPriceDetail">
        ...
        <div class="price-detail-box">
          ...
          <p>
            ...
            <span>
              {{ticketInfo.price | formatPrice}} × {{passengerNum}}人
            </span>
          </p>
          <p v-if="ticketInfo.serviceFee > 0">
            <span class="price-d-tit">服务费用</span>
            <span>{{ticketInfo.serviceFee | formatPrice('yuan')}} × {{passengerNum}}人</span>
          </p>
  ...
  export default {
    ...
    data () {
      return {
        ...
        EXPRESS_BUS: TOOL.TRAIN_EXPRESS_BUS,
        ticketInfo: {
          aAddress: {},
          bAddress: {},
          customContents:[]
    ...
    computed: {
      totalPrice () {
        ...
        if (this.passengerNum > 0) {
          ...
          return passengerPrice + insureprice + servicePrice - this.reducedAmount - this.orderCouponPrice - this.integralPrice
        } else {
    ...
    methods: {
      ...
      trainStationSkuFindById () {
        ...
        api.trainStationSkuFindById(this.orderData.skuId).then(res => {
      ...
      initActivityAndCoupon () {
        ...
        this.ticketAmount = this.ticketInfo.price
        this.passengerNum = this.orderData.passengers.length
